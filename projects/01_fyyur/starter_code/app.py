...
class Artist(db.Model):
    ...
    #  shows / past_shows, past_shows_count, upcoming_shows, upcoming_shows_count
...
def create_venue_submission():
    ...
    # name, city, state, adress, phone, genres, facebook_link
    # on successful db insert, flash success
    flash('Venue ' + request.form['name'] + ' was successfully listed!')
    venue = Venue(name=request.form.get('name'), city=request.form.get('city'), state=request.form.get('state'),
                  address=request.form.get('address'), phone=request.form.get('phone'), facebook_link=request.form.get('facebook_link'))
